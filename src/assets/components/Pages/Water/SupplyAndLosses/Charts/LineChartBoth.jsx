          ...
          {selectedTexts.map((text, index) =>
            visibleLines[text.name] ? (
              <Line
                ...
                yAxisId={
                  text.name ===
                    "Population connected to water supply industry, million" ||
                  text.name ===
                    "წყალმომარაგების სისტემაზე მიერთებული მოსახლეობის რაოდენობა, მილიონი"
                    ? "right"
                    : "left"
                }
