...
const StackedBarChartsWithNumbers = ({ chartInfo }) => {
  ...
  const CustomLegend = () => {
    ...
    return (
      <ul className="recharts-default-legend" style={{ flexWrap: "wrap" }}>
...
export default StackedBarChartsWithNumbers;
