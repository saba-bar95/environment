...
const LineCharts4 = ({ chartInfo }) => {
    ...
    useEffect(() => {
        const getData = async () => {
            ...
            const specificChartInfo = {
                ...chartInfo,
                // make sure these are the intended indices for this chart
            ...
            try {
                ...
                console.error("Error fetching data for LineCharts4:", e);
    ...
    // Custom Legend (same behavior/styles as your other charts)
    const CustomLegend = () => {
    ...
    // Custom Tooltip (same structure/styles as your other charts)
    ...
    return (
        ...
        >
            <div className="header">
                ...
                <div className="left">
                    <Download data={chartData} filename={chartInfo[`title_${language}`]} />
                </div>
            </div>
            ...
            <ResponsiveContainer width="100%" height={460}>
                <LineChart data={chartData}>
                    ...
                    <Brush dataKey="year" height={20} stroke="#8884d8" travellerWidth={5} />
                </LineChart>
            </ResponsiveContainer>
        </div>
    );
