...
const PrecipitationHeatmap = ({chartInfo, dataUrl}) => {
    ...
    // Allow configuration via chartInfo; fall back to your working URL
    ...
    const valueKey = chartInfo?.valueKey || "GEO - ANNUAL";
    ...
    const unitText =
        language === "ge" ? chartInfo?.unit_ge || "" : chartInfo?.unit_en || "";
