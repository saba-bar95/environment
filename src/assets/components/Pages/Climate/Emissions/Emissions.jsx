...
const Emissions = () => {
    ...
    const ChartInfo = [
        ...
        {
            title_ge: "სათბურის გაზების ემისიები გაზების ტიპის მიხედვით",
            title_en: "Greenhouse Gas Emissions by Gas Type",
            unit_ge: "ათასი ტონა CO2 ეკვივალენტი",
            unit_en: "Thousand Tonnes of CO2 Equivalent",
        ...
        <div className="section-container emissions">
            ...
            <div className="charts-section">
                <div className="chart-container" style={{width: "100%"}}>
                    {/* Manually render each chart, passing its specific config */}
                    ...
                    {/* --- 3. ADD the new AreaCharts2 component to the JSX --- */}
